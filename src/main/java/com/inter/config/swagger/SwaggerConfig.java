package com.inter.config.swagger;
...
public class SwaggerConfig {
	...
	@Value("${swagger.message.message200}")
	  ...
	  /**
	   *swagger message configuration and base package javadoc inter.config
	   */
	  ...
	  public Docket api() {
	    ...
	    responseMessageList.add(new ResponseMessageBuilder().code(500).message(error500)
	            		.build());
	    ...
	    responseMessageList.add(new ResponseMessageBuilder().code(404).message(error404)
	            .build());
	    responseMessageList.add(new ResponseMessageBuilder().code(200).message(message200)
        		.build());
